...
class PostRouter {
    ...
    postRoutes() {
        this.router.post('/addPost', GlobalMiddleWare_1.GlobalMiddleWare.authenticate, PostValidators_1.PostValidators.addPost(), GlobalMiddleWare_1.GlobalMiddleWare.checkError, PostController_1.PostController.addPost);
    }
    patchRoutes() {
